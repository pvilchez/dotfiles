...
" behaviour {
    ...
    " shortcuts & remappings {
        ...
        nnoremap j gj                   " make j behave normally
        nnoremap k gk                   " make k behave normally
...
" formatting {
    ...
    set colorcolumn=85                  " redline at column 85
    ...
    set softtabstop=4                   " tab = n spaces (see expandtab)
    set tabstop=4                       " real tab width, shown with list on
    set textwidth=79                    " define width of file
